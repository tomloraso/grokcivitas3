...
6. [Auth Session Boundary](./architecture/auth-session-boundary.md)
7. [Premium Access Boundary](./architecture/premium-access-boundary.md)
8. [Backend Conventions](./architecture/backend-conventions.md)
9. [Frontend Conventions](./architecture/frontend-conventions.md)
10. [Web Foundations (Phase 0D1)](./architecture/web-foundations-phase0.md)
11. [Testing Strategy](./architecture/testing-strategy.md)
12. [AI Extension Guide](./architecture/ai-extension-guide.md)
13. [School Compare](./architecture/school-compare.md)
14. [ADR 0001: Architecture](./adr/0001-architecture.md)
