...
This supplements `.planning/phases/phase-11-post-mvp/11E-performance-and-cache-optimization.md` with a near-term, evidence-based plan for the current product.
