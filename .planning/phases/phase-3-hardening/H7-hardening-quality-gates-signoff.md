# Phase 3 / H7 Design - Hardening Quality Gates And Sign-Off
...
- Depends on:
 - `.planning/phases/phase-3-hardening/H1-pipeline-run-policy-quality-gates.md`
 ...
 - `.planning/phases/phase-3-hardening/H4-data-completeness-contract-api-ui.md`
 - `.planning/phases/phase-3-hardening/H5-operational-observability-freshness-coverage-drift.md`
 - `.planning/phases/phase-3-hardening/H6-pipeline-resilience-performance-hardening.md`
  - `.agents/tooling.md`
  - `.agents/testing.md`
...
At closeout, add:
 ...
 - `.planning/phases/phase-3-hardening/signoff-YYYY-MM-DD.md`
...
- Final sign-off evidence is captured in `.planning/phases/phase-3-hardening/signoff-2026-03-04.md`.
