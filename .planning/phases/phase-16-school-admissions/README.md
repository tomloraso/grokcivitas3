# Phase 16 Design Index - School Admissions
...
1. `16A-join-key-foundation-and-source-contract.md`
2. `16B-admissions-pipeline-and-gold-schema.md`
3. `16C-serving-contract-and-benchmark-integration.md`
4. `16D-quality-gates.md`
