# Phase 14 Design Index - School Financial Benchmarks
...
- Legacy workstream IDs: `14A` through `14D`
...
1. `14A-source-contract-and-schema-freeze.md`
2. `14B-aar-pipeline-and-gold-schema.md`
3. `14C-serving-contract-and-benchmark-integration.md`
4. `14D-quality-gates.md`
