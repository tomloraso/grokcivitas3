...
Phase 13 should extend the existing React ownership model rather than scatter save state across shared primitives.
...
Current API caching is lightweight and hand-rolled. Phase 13 must account for that explicitly.
