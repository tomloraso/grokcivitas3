# Phase 20 Design Index - Similar-School Benchmarking
...
- Legacy workstream IDs: `20A` through `20D`
...
1. `20A-cohort-model-and-benchmark-schema.md`
2. `20B-materialization-and-backfill.md`
3. `20C-api-contract-and-web-adoption.md`
4. `20D-quality-gates.md`
