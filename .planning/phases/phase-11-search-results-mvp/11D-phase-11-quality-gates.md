...
- server-side `closest` and `ofsted` sorts exposed in the web MVP
- route-backed results overlay with desktop results table and mobile stacked cards
...
- The main search route becomes faster to interpret for results analysis without adding opaque ranking behavior.
