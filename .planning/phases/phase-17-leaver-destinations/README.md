# Phase 17 Design Index - Leaver Destinations
...
1. `17A-source-contract-and-bronze-strategy.md`
2. `17B-destinations-pipeline-and-gold-schema.md`
3. `17C-serving-contract-and-completeness.md`
