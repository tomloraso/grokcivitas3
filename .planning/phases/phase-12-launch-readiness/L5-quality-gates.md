...
Define the sign-off evidence required before Phase 12 (Product Foundation and Launch Readiness) is considered complete.
...
- Location-based SEO pages (Phase 20).
...
Phase 12 is complete when the following evidence is recorded in a `signoff-YYYY-MM-DD.md` file in the phase folder:
