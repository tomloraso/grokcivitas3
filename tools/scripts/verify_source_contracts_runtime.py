...
def verify_source_contracts_runtime() -> VerificationOutcome:
    ...
    ons_2019_sample_row = {
        ...
        ons_imd_contract.INCOME_SCORE_HEADER: "0.22",
        ons_imd_contract.INCOME_RANK_HEADER: "700",
        ons_imd_contract.INCOME_DECILE_HEADER: "2",
        ons_imd_contract.EMPLOYMENT_SCORE_HEADER: "0.18",
        ons_imd_contract.EMPLOYMENT_RANK_HEADER: "730",
        ons_imd_contract.EMPLOYMENT_DECILE_HEADER: "2",
        ons_imd_contract.EDUCATION_SCORE_HEADER: "12.4",
        ons_imd_contract.EDUCATION_RANK_HEADER: "810",
        ons_imd_contract.EDUCATION_DECILE_HEADER: "3",
        ons_imd_contract.HEALTH_SCORE_HEADER: "0.54",
        ons_imd_contract.HEALTH_RANK_HEADER: "760",
        ons_imd_contract.HEALTH_DECILE_HEADER: "3",
        ons_imd_contract.CRIME_SCORE_HEADER: "0.37",
        ons_imd_contract.CRIME_RANK_HEADER: "690",
        ons_imd_contract.CRIME_DECILE_HEADER: "2",
        ons_imd_contract.BARRIERS_SCORE_HEADER: "8.1",
        ons_imd_contract.BARRIERS_RANK_HEADER: "910",
        ons_imd_contract.BARRIERS_DECILE_HEADER: "4",
        ons_imd_contract.LIVING_ENVIRONMENT_SCORE_HEADER: "14.2",
        ons_imd_contract.LIVING_ENVIRONMENT_RANK_HEADER: "980",
        ...
        "Total population: mid 2015 (excluding prisoners)": "1650",
    }
    try:
        ons_imd_contract.validate_headers(
